...
describe('rewriting-proxy', function(){
  describe('#rewriteHTML()', function(){
    it('should do nothing', function(){
      ...
      var inst = proxy.rewriteHTML(html, "http://foo.com", function (str) { return str; }, null);
      assert.equal(inst, html);
    });
    it('should insert header script', function() {
      var html = "<html><head></head><body></body></html>";
      var inst = proxy.rewriteHTML(html, "http://foo.com", function (str) { return str; }, "alert(\"hi\");");
